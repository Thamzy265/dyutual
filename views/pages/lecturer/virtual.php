  ...
  <div class="full-window">
      ...
      <div class="virtual bg-grey pt-5 pb-5">
        <section class="container row">
           ...
           <section class="container d-flex justify-content-between pt-3">
            ...
            <div class="col-md-7">
                <div class="card p-2">
                   ...
                   <textarea id="responsecontainer" class="" name="" id="" cols="35" rows="7 " disabled></textarea> 
...
<script src="../../../js/virtualClass.js"></script>
