...
if(isset($_GET['id']) || isset($_GET['name'])){
    if(isset($_GET['id'])){
     ...
     $classes = json_decode($classesAll->searchClass($id,$name,'lecturer'),true);
}else{
...
<?php
    ...
    ?>
<div class="pt-3">
<div class="d-flex"><img class="icons pr-2" src="../images/icons/images (23).png" alt=""><h5>Class</h5></div>
        ...
        <table>
            ...
            <tbody>
                ...
                <form action="" method="get">
                    <input type="hidden" name="page" value="lecturer_classes">
                ...
                <td><a href="?page=lecturer_classes" class="btn text-light bg-grey">Clear</a></td>
            </tr>
            <tr>
                <td>1 All</td>
                <td></td>
