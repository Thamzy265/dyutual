...
<form class="pt-3" action="../route/route.php" method="post">
    <input type="hidden" name="id" value="<?php echo $data[0]['id'] ;?>">
        ...
        <div class="pt-3">
            <a href="?page=pass&&id=<?php echo $data[0]['id'];?>" name="studentPass" class="btn btn-warning">Change Password</a>
            <button type="submit" name="editStudent" class="btn btn-primary">Update Profile</button>
        </div>
