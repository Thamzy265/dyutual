    ...
    <div class="form-log container d-flex justify-content-center align-items-center">
        <div class="card col-md-4 pt-2 pb-2 border-0">
            ...
            <form action="route/route.php" method="post">
                <h4 class="text-center">Lecturer Login</h4>
                <?php
                if ($msg != null){
                    echo "<p class='alert text-danger'>$msg</p>";
                }else{
                    echo "  <p class=\"pb-2 alert text-info\">Enter your Lecturer login credentials</p>";
                }
                ?>
                ...
                <button class="btn btn-block btn-primary" name="lecturerLogin" type="submit">Login</button>
            </form>
        </div>
    </div>
</body>
